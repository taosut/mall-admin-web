    ...
    <div class="un-handle-layout">
      ...
      <div class="un-handle-content">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Pending refund request</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
          ...
          <div class="out-border">
            ...
            <div style="padding: 40px">
              ...
              <el-row class="font-medium">
                ...
                <el-col :span="6" class="overview-item-title">Tight stock</el-col>
          ...
          <div style="padding: 20px">
            <div>
              ...
              <div>
                ...
                <span style="color: #C0C4CC;font-size: 14px">Last month</span>
              </div>
            </div>
            <div style="margin-top: 20px;">
              ...
              <div>
                ...
                <span style="color: #C0C4CC;font-size: 14px">Last week</span>
              </div>
            </div>
            <div style="margin-top: 20px;">
