<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleSelectBrand()">Add to</el-button>
    </el-card>
      ...
      <el-table ref="homeBrandTable"
        ...
        <el-table-column label="Operating" width="180" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="handleEditSort(scope.$index, scope.row)">Edit
            </el-button>
            <el-button size="mini"
                       type="text"
    ...
    <el-dialog title="Set sort"
      ...
      <span slot="footer">
        ...
        <el-button type="primary" @click="handleUpdateSort" size="small">Update</el-button>
      </span>
    </el-dialog>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdateSort(){
        this.$confirm('Whether to modify the sort?', 'prompt', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      updateRecommendStatusStatus(ids,status){
        this.$confirm('Whether to modify the recommendation status?', 'prompt', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
