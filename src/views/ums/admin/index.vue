  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="Account number" align="center">
          <template slot-scope="scope">{{scope.row.username}}</template>
        </el-table-column>
        <el-table-column label="Name" align="center">
          <template slot-scope="scope">{{scope.row.nickName}}</template>
        </el-table-column>
        <el-table-column label="Mailbox" align="center">
        ...
        <el-table-column label="Operating" width="180" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="handleSelectRole(scope.$index, scope.row)">Assigning Roles
            </el-button>
            <el-button size="mini"
                       type="text"
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Delete the user?', 'prompt', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
