  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="roleTable"
        ...
        <el-table-column label="User number"  width="100" align="center">
        ...
        <el-table-column label="Enable" width="140" align="center">
        ...
        <el-table-column label="Operating" width="160" align="center">
          <template slot-scope="scope">
            <el-row>
              <el-button size="mini"
                         type="text"
              ...
              <el-button size="mini"
                         type="text"
                         @click="handleSelectResource(scope.$index, scope.row)">Distribute resources
              </el-button>
            </el-row>
            <el-row>
            <el-button size="mini"
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete the role?', 'prompt', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
