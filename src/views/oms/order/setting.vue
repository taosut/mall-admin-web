  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="orderSetting"
      ...
      <el-form-item label="Spike orders exceed: " prop="flashOrderOvertime">
        ...
        <span class="note-margin">No payment, order closes automatically</span>
      </el-form-item>
      <el-form-item label="Normal orders exceed: " prop="normalOrderOvertime">
      ...
      <el-form-item label="Shipped over: " prop="confirmOvertime">
        ...
        <span class="note-margin">Unreceived, order completed automatically</span>
      </el-form-item>
      <el-form-item label="Order completed more than: " prop="finishOvertime">
        ...
        <span class="note-margin">Automatically end transaction, cannot apply for after-sale</span>
      </el-form-item>
    ...
    methods:{
      confirm(formName){
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.$confirm('Whether to submit changes?', 'prompt', {
