<template>
  <div class="detail-container">
    <el-card shadow="never">
      <span class="font-title-medium">Returns</span>
      <el-table
        border
        ...
        <el-table-column label="Price / article number" width="180" align="center">
          <template slot-scope="scope">
            <span class="font-small">Price: $ {{scope.row.productRealPrice}}</span><br>
            <span class="font-small">Item: NO.{{scope.row.productId}}</span>
          </template>
        </el-table-column>
    ...
    <el-card shadow="never" class="standard-margin">
      <span class="font-title-medium">Ticket information</span>
      <div class="form-container-border">
        <el-row>
          <el-col :span="6" class="form-border form-left-bg font-small">Ticket number</el-col>
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Order for return apply</el-col>
      ...
      <div class="form-container-border">
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Confirm the refund amount
          </el-col>
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Choose a delivery point
          </el-col>
          <el-col class="form-border font-small" style="height:52px" :span="18">
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===2">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Consignee</el-col>
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===0">
        ...
        <el-button type="danger" size="small" @click="handleUpdateStatus(3)">Refuse to return</el-button>
      </div>
    ...
    methods: {
      ...
      getDetail() {
        getApplyDetail(this.id).then(response => {
          ...
          //Return neutralization completed
